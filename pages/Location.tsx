...
import { MapPin, Navigation, ArrowRight, CornerDownRight, CornerRightUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-brand-gray">
      <div className="bg-brand-dark py-20 text-center text-white">
        ...
        <p className="text-slate-400 text-lg flex items-center justify-center gap-2">
          ...
          Kilmacredock, Maynooth, Co.Kildare
        </p>
      </div>
          ...
          <div className="lg:w-7/12 relative bg-slate-200 group overflow-hidden">
             ...
             <div className="absolute inset-0 flex items-center justify-center pointer-events-none p-4">
                <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-2xl flex flex-col items-center max-w-xs text-center transform transition-transform group-hover:scale-105 duration-300">
                  ...
                  <span className="font-display font-bold text-xl text-slate-900">JM Motors</span>
                  <span className="text-sm text-slate-500 mt-1 mb-4">Kilmacredock, Maynooth</span>
                  <a 
                    href="https://www.google.com/maps/search/?api=1&query=Kilmacredock+Maynooth" 
                    target="_blank" 
                  ...
                  >
                    Open Google Maps <CornerRightUp size={14} />
                  </a>
                </div>
             </div>
          </div>
